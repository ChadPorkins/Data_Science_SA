...
```{r}
agostino.test(log10(attacks$casualties))
```
...
```{r}
res4= glm(age_time_death ~ wounded_average + killed_average + casualties, data = male_attackers , family = "poisson"	)
summary(res4)
```
